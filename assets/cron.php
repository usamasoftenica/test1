...
class Database{
	...
	private $user = "keyvetco_colorado";
	private $password = "CEdjZ_~Kpd63=rU";
	private $database = "keyvetco_colorado";
	private $conn;
	...
	$daysNo=$NoOfdays->fetch_object();
	 ...
	 while($row = mysqli_fetch_array($result)){
			   ...
			   //          echo "</tr>";
			        ...
			        }else if($days==3 && $row['payment_by']!=2)
					        {
					      	$mail = new PHPMailer(true);
							$mailchimp = new \MailchimpMarketing\ApiClient();
							$mailchimp->setConfig([
