<!--model for forum update-->
<!--<div class="modal fade" id="forum-update" tabindex="-1" role="dialog" aria-labelledby="firstqModalLabel" aria-hidden="true">-->
<!--	<div class="modal-dialog" role="document">-->
<!--		<div class="modal-content">-->
<!--			<div class="modal-header">-->
<!--				<h5 class="modal-title" id="firstqModalLabel">Update Forum</h5>-->
<!--				<button type="button" class="close" data-dismiss="modal" aria-label="Close">-->
<!--					<span aria-hidden="true">&times;</span>-->
<!--				</button>-->
<!--			</div>-->
<!--			<div class="modal-body">-->
<!--				<form  method="post" id="forum-updatd" action="#" style="margin: 0px;">-->
<!--					<div class="row">-->
<!--						<div class="col-md-12">-->
<!--							<div class="form-group">-->
<!--								<label>Question</label>-->
<!--								<input id="question-sentence" class="form-control" type="text" placeholder="">-->
<!--								<p style="display: none;color:red">Please enter a question</p>-->
<!--							</div>-->
<!--						</div>-->
<!--						<div class="col-md-12">-->
<!--							<div class="row">-->
...
<!--										<input id="question-description" class="form-control" type="text" placeholder="">-->
<!--										<p style="display: none;color: red ;">Please enter a description</p>-->
<!--									</div>-->
<!--								</div>-->
<!--							</div>-->
<!--						</div>-->
...
<!--											<select name="commentss" id="checkComments">-->
...
<!--									</li>-->
			...
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title">View Pending Topics</h4>
					</div>
					<div class="content">
						<div class="payment-list informational">

							<table id="all-forum-table">
								<thead>
								<tr>
									<th>ID</th>
									<th>Date</th>
