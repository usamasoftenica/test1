...
<div class="modal fade" id="editModalReply" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="javascript:void(0)" method="post" id="coment_edit_approved_reply">
				<div class="modal-body">
				...
				<div class="card">
					...
					<div class="content">
						<div id="com-forum" class="payment-list informational">
							...
							<table id="forum-all-comments-table">
								<thead>
								<tr>
									<th>ID</th>
									<th>Date</th>
							...
							<table style="width: 100%;" id="forum-all-reply-table">
								<thead>
								<tr>
									<th>ID</th>
									<th>Date</th>
