...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="post" id="coment_edit_blog">
...
<div class="modal fade" id="editModalReply" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="javascript:void(0)" method="post" id="coment_edit_approved_reply_blog">
				<div class="modal-body">
						...
						<div class="search-form">
							<form method="post" action="<?php echo base_url();?>/admin/view-all-comments">
								<ul>
									...
									<li><input type="button" class="btn-primary btn commentsSubmit1" value="Search"></li>
								</ul>
							</form>
						</div>
				...
				<div class="card">
					...
					<div class="content">
						<div class="payment-list informational">
							...
							<table id="blog-all-comments-table">
								<thead>
								<tr>
									<th>ID</th>
									<th>Date</th>
									<th>Name</th>
									<th id="reply-c" class="custom-width2">Comments</th>
