            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Outbound Email</h4>
                            </div>
                            <div class="content">
                                <?php if($this->session->flashdata('error1')!=""){  ?>
                                           ...
                                           <div class="alert alert-success">
                                            ...
                                            <?php } ;?>
                                <form action="<?php echo base_url() ?>admin/add-outboundemail" class="outbound-email" id="outbound-email" method="post">
                                     <ul>
                                          <li>
                                             <label for="">Email Subject</label>
                                             <input type="text" name="title" value="<?php echo $email->title; ?>" class="form-control" placeholder="">
                                          ...
                                          <li class="full">
                                            ...
                                            <textarea name="details" id="description" class="ckeditor"><?php if ($this->session->flashdata('data')!="" && array_key_exists('description', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['description'];} echo $email->descritpion; ?></textarea>
                                          ...
                                          <li><input type="submit"  class="btn btn-info btn-fill color-red" value="Submit"></li>
                                     </ul>
                                </form>
