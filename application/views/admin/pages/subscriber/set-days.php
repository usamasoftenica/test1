                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <form action="<?php echo base_url() ?>admin/update-days" class="outbound-email" id="outbound-email" method="post">

                                     <ul>

                                          <li>

                                             <label for="">Set Expiry Email Days</label>

                                             <input type="number" step="0.01" name="amount" value="<?php echo $amount->noDays; ?>" class="form-control" placeholder="">
