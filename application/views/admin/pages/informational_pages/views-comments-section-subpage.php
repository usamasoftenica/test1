                                 ...
                                 <div class="form-group">
                                                ...
                                                <select class="form-control" name="subPage" id="subPage">
                                                 ...
                                                 ?>
                                                    ...
                                                    <option <?php if($value->id==$SubpageDetails[0]->id){?> selected <?php } ?> value="<?php echo base_url() ?>admin/comments-view-subpage/<?php echo $id; ?>/<?php echo $value->id ?>"><?php echo $value->name;?></option>
                                                    <?php } ?>
                                                  
                                               </select>
                                            
                                            </div>
                                <h4 class="title">View <?php echo $SubpageDetails[0]->name; ?> Comments <a href="<?php echo base_url() ?>admin/comments-view/<?php echo $id; ?>" class="btn btn-info btn-fill pull-right color-red">View Parent Page Comments</a></h4>
                            </div>
                            <div class="content">
                             ...
                             <!--   <a href="<?php //echo base_url()."admin/add-menu-item/".$informationalpages->info_id?>" class="btn btn-info btn-fill pull-right color-red">Add New Side Menu Item</a>  -->
                                    ...
                                    <?php foreach ($comments as $key => $comment) {?>
                                     ...
                                     <?php
                                          ...
                                          $join= array('0'=>['subscribe','replys.user_id = subscribe.id','left']);
                                              $where = array('comment_id' => $comment->comID,'reply_approved'=>1, 'menus_id'=>$comment->menuitem_id );
                                        ...
                                        <div class="thumb-list  newCommentsshow">
                                          ...
                                          <?php } ?>
                                              <a class="comment-reply-link comment-replyss-subpage" href="javascript:void(0)" data-id="<?php echo $comment->comID;?> " data-menuid="<?php echo $comment->menuitem_id;?>">Reply</a>
                                ...
                                <?php } ?>
                                 ...
                                 <form action="javascript:void(0)" method="post" id="comment_post_subpage">
                                   <input type="hidden" name="menuid" class="menusubpage" value="<?php echo $this->uri->segment(4); ?>">
                                   <input type="hidden" name="page_id" class="page_id" value="<?php echo $this->uri->segment(3); ?>">
                                   <!--  <p>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="comment-respond">
                                     ...
                                     <form method="post" id="coment_reply_subpage">
                                      <input type="hidden" name="inputhidden" class="inputhidden" value="">
                                      <input type="hidden" name="menuid" class="menudid" value="<?php echo $this->uri->segment(4); ?>">
