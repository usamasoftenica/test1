...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" id="coment_edit_approved_info">
...
<div class="modal fade" id="editModalReply" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" id="coment_edit_approved_reply_info" action="javascript:void(0)">
                <div class="modal-body">
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="search-form">
                            <form method="post" action="<?php echo base_url();?>/admin/approve-all-comments">
                                <ul>
                                    <li>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="pageName" id="pageName">
                                                ...
                                                <?php foreach ($information as $key => $value) {
                                                    # code...
                                                    ?>
                                                    <option value="<?php echo $value->info_id; ?>"><?php echo $value->name;?></option>
                                                <?php } ?>
                                    ...
                                    <!--  -->
                                    <li><input type="button" class="btn-primary btn commentsSubmitinfor" value="Search"></li>
                                </ul>
                            </form>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="content">
                        <div id="comnt-tbl-cstm" class="payment-list informational">
                        ...
                        <div class="clearfix"></div>
                        <div id="replies-table-costum" style="display: none;" class="payment-list informational">
                            <table style="width: 100%;" id="approve_comments2">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Date</th>
