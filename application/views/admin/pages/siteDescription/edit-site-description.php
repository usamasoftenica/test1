                ...
                <div class="row">
                    ...
                    <form action="<?php echo base_url(); ?>admin/update-site-description" method="post" id="add_site_description" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 payment-list">
                          ...
                          <ul><li style="float: right; margin: 11px">

                            <input type="submit" name="ActivatePrevious"  value="Activate & Previous">

                            <input type="submit" name="ActivateNext"  value="Activate & Next">

                            <input type="submit" name="publish"  value="Activate"> 

                            <input  class="Draft" formnovalidate="formnovalidate" type="button"  name="save" value="Save as Draft"></li></ul></div>



                        <div class="col-md-12">

                          <input name="id" type="hidden" container-fluid="id" value="<?php echo $sitedescription->siteId;?>">
                                           ...
                                           <!--  <li>
                                            ...
                                            <li>
                                                ...
                                                <select name="childcom" id="childcom">
                                                    ...
                                                    <option value="81">No Child Campground</option>
                                             ...
                                             <li>
                                                ...
                                                <label value="">Campground Map (optional)</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="submit" name="ActivateNext"  value="Activate & Next">
                                            ...
                                            <input type="submit" name="publish" value="Activate"> <input  class="Draft" formnovalidate="formnovalidate" type="button" name="save" value="Save as Draft"></li>
