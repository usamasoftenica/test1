		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add Parent Campground</h4>
                            </div>
            ...
            <form action="<?php echo base_url(); ?>admin/new-parent-campground" method="post" id="add_paresnt_comp" enctype="multipart/form-data">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <input class="form-control"  value="<?php if ($this->session->flashdata('data')!="" && array_key_exists('name', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['name'];}?>" name="name" id="name" type="text" placeholder="Parent Campground">
                                            </li>
                                             <!-- <li>
                                                <label>Slug</label>
                                                <input class="form-control" value="<?php if ($this->session->flashdata('data')!="" && array_key_exists('slug', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['slug'];}?>" name="slug" type="text" placeholder="Enter slug">
                                            </li> -->
                                             <li>
                                              <div class="form-group">
                                            <label for="comment">ADD CAMPGROUND MAP LINK <small>(optional)</small></label>
                                            <textarea placeholder="Enter Campground Map Link" name="com_map" class="form-control" rows="5"><?php if ($this->session->flashdata('data')!="" && array_key_exists('com_map', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['com_map'];}?></textarea>
                                          </div>

                                            </li>
                                            <li>
                                                <label>ADD YOUTUBE LINK <small>(optional)</small></label>
                                                <input class="form-control" name="youtube_link" value="<?php if ($this->session->flashdata('data')!="" && array_key_exists('youtube_link', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['youtube_link'];}?>" type="text" placeholder="ENTER YOUTUBE LINK">
                                            </li>
                                             <li class="full"><label>Description <small> (<strong>Tip:</strong> You can add tables to format description in tabular form.)</small></label><textarea name="description" class="ckeditor" id="description"><?php if ($this->session->flashdata('data')!="" && array_key_exists('description', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['description'];}?></textarea></li>
                                           ...
                                           <!--  <li>
                                            ...
                                            <li>
                                              ...
                                              <li>
                                                ...
                                                <input class="form-control" value="<?php if ($this->session->flashdata('data')!="" && array_key_exists('title', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['title'];}?>" name="title" type="text" value="">
                                            </li>
                                            <li>
                                                <label>KEYWORDS FOR META TAG(COMMA SEPERATED)</label>
                                                <input class="form-control" value="<?php if ($this->session->flashdata('data')!="" && array_key_exists('keyword', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['keyword'];}?>" type="text" name="keyword" placeholder="">
                                            </li>
                                            <li class="full">
                                                <label>META DESCRIPTION</label>
                                                <textarea class="form-control" name="meta_description" value="<?php if ($this->session->flashdata('data')!="" && array_key_exists('meta_description', $this->session->flashdata('data'))){echo $this->session->flashdata('data')['meta_description'];}?>" placeholder=""></textarea>
                                            </li>
                                       ...
                                       <!--      <li class="width-50">
                                            ...
                                            <li class="full"><input type="submit" name="publish" value="Activate"> <input  formnovalidate="formnovalidate" type="submit" name="save" id="saveAsDraft" value="Save as Draft"></li>
                                        </ul>
                                    </form>
                                </div>
