...
<html lang="en">
  <head>
    ...
    <title>Colorado Campgrounds | Change Password</title>
...
<?php } ;?>
                            ...
                            <form action="<?php echo base_url();?>admin/update-password" method="post" id="change_password">
...
<spam>   <?php echo $this->session->flashdata('login_error'); ?>  </spam>
 ...
 <?php } ;?>
                                ...
                                <ul>
                                     ...
                                     <li><input type="password" name="password" id="password" placeholder="Enter Your Password"></li>
                                      <li><input type="password" name="confirm_password" placeholder="Enter Your Password"></li>
