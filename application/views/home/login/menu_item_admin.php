                            ...
                            <div class="ccg-sidebar scroll">
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="nav-item">
                                    ...
                                    ?>
                                        <li><a class="nav-link submenus" data-id="<?php echo $value->id; ?>" data-count="10" href="<?php echo base_url();?>informations/<?php echo $info->slug;?>/<?php echo $value->menu_slug;?>"><?php echo $value->name;?></a>
