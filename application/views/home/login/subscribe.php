                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="ccg-sign-form">
                                ...
                                <h2>
                                  <ul>
                                    ...
                                    <li style="list-style-position: outside;">
                                      If you prefer a one-month free trial to explore Colorado Campgrounds, please click the following link to initiate your one-month free trial, then complete the form below:
                                      <center style="margin: 10px;">  
                                          <a class="btn" style="background-color: #92d050" href="<?php echo base_url();?>free-trial"><b>ONE-MONTH FREE TRIAL</b></a>
                                      </center>
                                     
                                    </li>
                                    <li style="list-style-position: outside;">If you would like a $<?php echo $amount->pAmount; ?> one-year subscription to Colorado Campgrounds (which you may cancel at any time) please complete the following:</li>
                                  </ul>
                                  </h2>
                                ...
                                <form action="<?php echo base_url();?>subscribe/store" enctype="multipart/form-data" method="post" id="subscribe">
                                    ...
                                    <ul>
                                        ...
                                        <li class="width-50"><label class="paybtn"  for="paya"><input id="paya" value="2" type="radio" name="pay"> Pay By Check</label></li>
                                        <li class="width-50"><label class="paybtn" for="payb"><input id="payb" value="1" type="radio" name="pay"> Paypal</label></li>
