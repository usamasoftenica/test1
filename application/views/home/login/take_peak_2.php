                ...
                <div class="container">
                    ...
                    <?php 
                               if($value->youtube_link !=""){
                                        ...
                                        //$output = str_replace('_', '', $value->youtube_link);
                    ...
                    <input type="hidden" class="data-campSite-<?php echo $value->slug; ?>" name="campSiteMap" value="<?php echo htmlspecialchars($value->campSiteMap); ?>">
                      ...
                      <?php if(!empty($region)){ ?>
                         ...
                         <?php } ?>
                            ...
                            <div style="display: none;" class="campground-map scroll">
                              <?php if(!empty($region)){ ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
     ...
     $( ".new-details-parent" ).trigger( "click" );
