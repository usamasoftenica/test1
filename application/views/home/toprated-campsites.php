                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="site-search">
                                 ...
                                 <form action="javascript:void(0)"  method="post" id="fav-form" enctype="multipart/form-data">
                                   <ul class="show-search-form popup">
                                    <input id="favourite_peggy" type="hidden" name="favourite_peggy" value="0">

                                        <li>
                                            <label for="">What Colorado Region do you want to explore?</label>
                                            <select name="regionSearch" class="form-control" id="regionSearch-fav"  >
